    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div class="filter">
                ...
                <p>
                    <asp:TextBox ID="MinPriceTB" runat="server" OnTextChanged="MinPriceTB_TextChanged" AutoPostBack="true"></asp:TextBox>원
            &nbsp;~<asp:TextBox ID="MaxPriceTB" runat="server" OnTextChanged="MaxPriceTB_TextChanged" AutoPostBack="true"></asp:TextBox>원
                </p>
            </div>
            <div class="result">
