...
namespace WebProgrammingProject_F22.Board
{
    public partial class Write : System.Web.UI.Page
    {
        ...
        {
            string insertSQL = "INSERT INTO board (writer, password, title, massage, ";
            insertSQL += "ref_id, inner_id, depth, read_count, del_flag, reg_date) ";
            insertSQL += "VALUES(@writer, @password, @title, @massage, 0, 0, 0, 0, ";
            insertSQL += "'N', GETDATE())";
            ...
            cmd.Parameters.AddWithValue("@massage", TextMessage.Text);
