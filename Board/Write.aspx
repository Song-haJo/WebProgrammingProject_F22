<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Write.aspx.cs" Inherits="WebProgrammingProject_F22.Board.Write" %>
        ...
        <div>
            <table style="width:100%;">
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <asp:LinkButton ID="btnWrite" runat="server" OnClick="btnWrite_Click">[쓰기]</asp:LinkButton>
                    </td>
                    <td>
